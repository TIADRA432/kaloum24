...
├── tests_fonctionnels.py   # 329 tests de bout en bout
...
329 tests couvrant : pages publiques, paywall, cycle de vie des commentaires,
...
widget officiel absent de tout article ordinaire).
